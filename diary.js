/* =====================================================================
   ...
   Newest first is handled automatically (sorted by date).
   date: "YYYY-MM-DD", mood: an emoji, tags: array of short labels.
   ===================================================================== */
(function () {
  "use strict";
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (!list.length) {
      box.innerHTML = '<p class="state-msg">No diary entries yet.</p>';
      return;
    }
    ...
    list.forEach(function (e) {
      ...
      entry.innerHTML =
        '<div class="diary-head">' +
          ...
          '<span class="diary-mood emoji">' + (e.mood || "") + '</span>' +
        '</div>' +
        '<h3>' + e.title + '</h3>' +
        '<p>' + e.body + '</p>' +
